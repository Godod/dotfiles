...
autocmd("LspAttach", {
    ...
    callback = function(e)
        ...
        set("n", "<leader>cws", function() vim.lsp.buf.workspace_symbol() end, opts)
        set("n", "<leader>cd", function() vim.diagnostic.open_float() end, opts)
        set("n", "<leader>ca", function() vim.lsp.buf.code_action() end, opts)
        set("n", "<leader>crf", function() vim.lsp.buf.references() end, opts)
        set("n", "<leader>crn", function() vim.lsp.buf.rename() end, opts)
        set("i", "<leader>cs", function() vim.lsp.buf.signature_help() end, opts)
